...
function buildDefaultListComposition(options: StyleOptions): GeminiComposition {
  ...
  <section class="nf-random-shell">
    <div class="nf-random-panel" data-random-panel>
      ...
      <p class="nf-random-meta" data-random-meta>${
        highlight
      ...
      <p class="nf-random-logline" data-random-logline>${
        highlight ? escapeHtml(highlight.logline) : "We will display a logline once a film is selected."
      }</p>
